  ...
  2021: {
    ...
    subcommittees: [
      ...
      },
      {
        name: "Freerooms",
        directors: [
          { name: "Mun Joon Teo", imgUrl: "munjoonteo" },
        ],
        subcommittee: [
      ...
      },
      {
        name: "Structs",
        directors: [
          { name: "Tim Zhang", imgUrl: "Tymotex" },
        ],
        subcommittee: [
          { name: "Alexander Cunio", imgUrl: "amcunio" },
      ...
      },
      {
        name: "Website",
        directors: [
          { name: "Matt Rossouw", imgUrl: "omeh-a" },
        ],
        subcommittee: [
    ...
    subcommittees: [
      {
        name: "Chaos",
        directors: [
          { name: "Lewis Cullen", imgUrl: "stapletm" },
      ...
      },
      {
        name: "Circles",
        directors: [
          { name: "Sanojan Thiyagara", imgUrl: "Snuzzn" },
          { name: "Gabriel Ting", imgUrl: "gtangelo" },
          { name: "Peter Derias", imgUrl: "Peedee2002" },
        ],
        subcommittee: [
          { name: "Leonardo Fan", imgUrl: "leonardo-fan" },
          { name: "Uzaif Sheikh", imgUrl: "Uzaif-Sheikh" },
          { name: "Kellie Yau", imgUrl: "kellieyau" },
      ...
      },
      {
        ...
        directors: [
          ...
          { name: "Victoria Vu", imgUrl: "auvictoriavu" },
        ],
        subcommittee: [
          ...
          { name: "Damjan Stevanoski", imgUrl: "damo190" },
          { name: "Kevin Tong", imgUrl: "k-tong" },
          { name: "Archit Mahajan", imgUrl: "apm106" },
          { name: "Steven Chye", imgUrl: "sschye21" },
        ]
      },
      {
        name: "Discord\u00A0Bot",
        directors: [
          ...
          { name: "Riz Manter", imgUrl: "rizmanter11" },
          { name: "Sanyam Jain", imgUrl: "sanyamjain47" },
        ],
        subcommittee: [
          { name: "Harry Zhang", imgUrl: "chrozure" },
      ...
      },
      {
        ...
        subcommittee: [
          ...
          { name: "Cheryl Ouyang", imgUrl: "cherylouyang" },
          { name: "Celia He", imgUrl: "XiangyiHe" },
          { name: "Eric Liu", imgUrl: "fxlui" },
          { name: "Justin Wu", imgUrl: "Jwu44" },
          { name: "Liam Chen", imgUrl: "ligam0414" },
        ]
      },
      {
        name: "Jobsboard",
        ...
        subcommittee: [
          ...
          { name: "Avijit Prasad", imgUrl: "avijits01" },
          { name: "Sam Yu", imgUrl: "samyu1204" },
      ...
      },
      {
        ...
        directors: [
          { name: "Mun Joon Teo", imgUrl: "munjoonteo" },
          { name: "Oliver Xu", imgUrl: "oliverxu42" },
        ],
        subcommittee: [
      ...
      },
      {
        ...
        subcommittee: [
          ...
          { name: "Brian Zhang", imgUrl: "brianzhang2101" },
    ...
    subcommittees: [
      ...
      },
      {
        ...
        subcommittee: [
          ...
          { name: "Nicole Yan", imgUrl: "crocyoiin" },
        ]
      },
      {
        name: "Jobsboard",
    ...
    subcommittees: [
      ...
      },
      {
        ...
        subcommittee: [
          ...
          { name: "Hannah Ahn", imgUrl: "TimezDed" },
        ]
      },
      {
        name: "Jobsboard",
        ...
        subcommittee: [
          ...
          { name: "Han Nguyen", imgUrl: "hanhnguyengiahan" },
        ]
      },
      {
        name: "Notangles",
      ...
      },
      {
        name: "Structs",
        directors: [
          { name: "Shubhum Shah", imgUrl: "Shubh141" },
          { name: "David Zhou", imgUrl: "Dammshine" },
        ],
        subcommittee: [
          ...
          { name: "Hindie Suputra", imgUrl: "NE1NN" },
        ]
      },
      {
        name: "Unilectives",
        ...
        subcommittee: [
          ...
          { name: "Urja Arora", imgUrl: "ur-ja" },
          { name: "Falco Widjaya", imgUrl: "maximilianfalco" },
          { name: "Tom Forsyth", imgUrl: "3syth" },
          { name: "Adrian Balbalosa", imgUrl: "adrianbalbs" },
          { name: "Kevin Sutandi", imgUrl: "KevinSutandi" },
