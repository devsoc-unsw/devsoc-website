  ...
  return (
    ...
    >
      ...
      <Stack alignItems='center'>
        <Typography padding={ 5 } fontSize={ { xs: "1rem", sm: "1.75rem" } }>Our flagship projects are proudly supported
          by</Typography>
...
const SponsorLogo = ( props: SponsorLogoProps ) => {
  const { data } = props
  return (
    <Stack flexDirection="row" marginBottom={ 20 } direction={ { xs: "column", lg: "row" } } spacing={ 5 }>
      {
