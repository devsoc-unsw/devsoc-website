...
import { starlightProjectData, starlightSupporterData, SponsorInfo } from "../data";
    ...
    return (
        <PageSection title={`Starlight ${selectedYear}`}>
            ...
            <Stack
                ...
                sx={{ gridGap: "20px" }}
            >
                {starlightSupporterData[selectedYear].supporterLogos.map((sponsor, idx) => {
            ...
            {starlightSupporterData[selectedYear].industryLogos && starlightSupporterData[selectedYear].industryLogos.length > 0 && (
                <>
                    ...
                    <Stack
                        ...
                        sx={{ gridGap: "32px" }}
                    >
                        {starlightSupporterData[selectedYear].industryLogos.map((sponsor, idx) => renderLogoRows(idx, sponsor))}
                    </Stack>
                </>
            )}
